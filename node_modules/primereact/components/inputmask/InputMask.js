    ...
    _createClass(InputMask, [{
        ...
        value: function onFocus(event) {
            ...
            this.caretTimeoutId = setTimeout(function () {
                if (_this2.input !== document.activeElement) {
                    return;
                }
                _this2.writeBuffer();
                if (pos === _this2.props.mask.replace("?", "").length) {
                    _this2.caret(0, pos);
                } else {
                    _this2.caret(pos);
                }
                _this2.updateFilledState();
            }, 10);
        }
    }, {
        key: 'onInput',
        ...
        value: function handleInputChange(event) {
            ...
            setTimeout(function () {
                var pos = _this3.checkVal(true);
                _this3.caret(pos);
                _this3.updateModel(event);
                if (_this3.props.onComplete && _this3.isCompleted()) {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(_InputText.InputText, { id: this.props.id, ref: function ref(el) {
                ...
                }, type: this.props.type, name: this.props.name, style: this.props.style, className: this.props.className, placeholder: this.props.placeholder,
