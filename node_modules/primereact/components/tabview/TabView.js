...
var TabView = exports.TabView = function (_Component2) {
    ...
    function TabView(props) {
        ...
        _this2.state = {
            activeIndex: _this2.props.activeIndex || 0
        };
        return _this2;
    }
    ...
    _createClass(TabView, [{
        ...
        value: function renderTabHeader(tab, index) {
            ...
            return _react2.default.createElement(
                'li',
                { className: className, role: 'presentation', style: tab.props.headerStyle },
                _react2.default.createElement(
                    'a',
                    { role: 'tab', href: '#' + ariaControls, onClick: function onClick(e) {
