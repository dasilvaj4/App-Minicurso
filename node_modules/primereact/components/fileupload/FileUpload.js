...
var FileUpload = exports.FileUpload = function (_Component) {
    ...
    _createClass(FileUpload, [{
        ...
        value: function renderChooseButton() {
            ...
            var className = (0, _classnames2.default)('ui-fileupload-choose ui-button ui-widget ui-state-default ui-corner-all');

            return _react2.default.createElement(
                'span',
                { icon: 'fa-plus', className: className },
                ...
                _react2.default.createElement('span', { className: 'ui-button-icon ui-button-icon-left ui-clickable fa fa-fw fa-plus' }),
            ...
            return _react2.default.createElement(
                ...
                this.state.files.map(function (file, index) {
                    ...
                    var removeButton = _react2.default.createElement(
                        'div',
                        null,
                        _react2.default.createElement(_Button.Button, { type: 'button', icon: 'fa-close', onClick: function onClick() {
        ...
        value: function renderAdvanced() {
            ...
            if (!this.props.auto) {
                uploadButton = _react2.default.createElement(_Button.Button, { label: this.props.uploadLabel, icon: 'fa-upload', onClick: this.upload, disabled: this.props.disabled || !this.hasFiles() });
                cancelButton = _react2.default.createElement(_Button.Button, { label: this.props.cancelLabel, icon: 'fa-close', onClick: this.clear, disabled: this.props.disabled || !this.hasFiles() });
            }
        ...
        value: function renderBasic() {
            ...
            var iconClassName = (0, _classnames2.default)('ui-button-icon-left fa', { 'fa-plus': !this.hasFiles() || this.props.auto, 'fa-upload': this.hasFiles() && !this.props.auto });
