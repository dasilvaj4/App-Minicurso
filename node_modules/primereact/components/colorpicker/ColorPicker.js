...
var ColorPicker = exports.ColorPicker = function (_Component) {
    ...
    _createClass(ColorPicker, [{
        ...
        value: function onHueMousedown(event) {
            ...
            this.pickHue(event);
            _DomHandler2.default.addClass(this.container, 'ui-colorpicker-dragging');
        }
    }, {
        key: 'pickHue',
        ...
        value: function onDocumentMouseUp() {
            ...
            _DomHandler2.default.removeClass(this.container, 'ui-colorpicker-dragging');
        ...
        value: function renderColorSelector() {
            ...
            return _react2.default.createElement(
                'div',
                { ref: function ref(el) {
                        return _this2.colorSelector = el;
        ...
        value: function renderInput() {
            ...
            if (!this.props.inline) {
                var inputClassName = (0, _classnames2.default)('ui-colorpicker-preview ui-inputtext ui-state-default ui-corner-all', {
                    'ui-state-disabled': this.props.disabled
                });

                return _react2.default.createElement('input', { ref: function ref(el) {
                        return _this4.input = el;
                    }, type: 'text', className: inputClassName, readOnly: 'readonly', id: this.props.inputId, tabIndex: this.props.tabIndex, disabled: this.props.disabled,
        ...
        value: function render() {
            ...
            var className = (0, _classnames2.default)('ui-colorpicker ui-widget', this.props.className, { 'ui-colorpicker-overlay': !this.props.inline });
            ...
            return _react2.default.createElement(
                ...
                input,
                _react2.default.createElement(
                    _ColorPickerPanel.ColorPickerPanel,
                    { ref: function ref(el) {
